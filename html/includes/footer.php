                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 my-3 me-auto">
                            <div class="pb-4">
                                <img class="footer-logo-light" src="../../assets/img/header-logo.png" title="" alt="" width="200">
                                <img class="footer-logo-dark" src="../../assets/img/header-logo.png" title="" alt="" width="200">
                            </div>
                        ...
                        <div class="col-lg-3 col-sm-6 my-3">
                            ...
                            <ul class="list-unstyled footer-link-01 m-0">
                                ...
                                <li>
                                    <a class="link-white" href="#">Something Coming Soon !</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-3 col-sm-6 my-3">
